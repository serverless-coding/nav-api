    ...
    >
      <ul className='flex relative ml-0'>
        ...
        <li className='font-bold'>
          <Link href='https://github.com/serverless-coding/frontend-nav'>Github</Link>
        </li>
      </ul>
      ...
      <footer className='relative flex justify-start'>
        <Link href='https://github.com/serverless-coding/nav-api'>
          <p>&copy; serverless</p>
        </Link>
      </footer>
    </main >
